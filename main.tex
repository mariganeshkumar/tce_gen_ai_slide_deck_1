...
\begin{column}{0.48\textwidth}
    ...
    \end{block}
    \vspace{0.2cm}
    \begin{block}{3. Programming (GitHub Copilot / Gemini)}
        \footnotesize
        \textbf{Prompt:} "Write a C program to swap two numbers without a temporary variable." \\
        \textbf{Output:} \\
        \texttt{a = a + b;} \\
        \texttt{b = a - b;} \\
        \texttt{a = a - b;}
...
\begin{column}{0.48\textwidth}
    \begin{block}{2. Image (Midjourney / DALL-E 3)}
        \footnotesize
        \textbf{Prompt:} "Students doing GEN AI lab in the year 2026 at Thiagarajar College Of Engineering" \\
        \centering
...
\begin{figure}
    \centering
    \includegraphics[width=0.3\linewidth]{images/perceptron_hands_on_qr.png}
\end{figure}
...
\begin{itemize}
    ...
    \item Public Repository: \url{https://github.com/mariganeshkumar/tce_gen_ai_slide_deck_1/blob/main/hands-on/Perceptron_Hands_ON.ipynb}
\end{itemize}
...
\begin{figure}
    \centering
    \includegraphics[width=0.3\linewidth]{images/auto_encoder_hands_on_qr.png}
\end{figure}
...
\begin{itemize}
    ...
    \item Public Repository: \url{https://github.com/mariganeshkumar/tce_gen_ai_slide_deck_1/blob/main/hands-on/Auto_Encoder_Hands_On.ipynb}
\end{itemize}
\end{frame}
